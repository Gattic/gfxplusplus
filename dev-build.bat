...
:: Usage: dev-build.bat [VS_VERSION]
:: Examples:
::   dev-build.bat              (VS 2022)
::   dev-build.bat 2019         (VS 2019)
::
...
echo ============================================
echo  gfxplusplus - Dev Build (Windows)
...
echo ============================================
echo  Done! gfxplusplus dev build installed to %USERPROFILE%\gfxplusplus
